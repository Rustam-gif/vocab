...
const styles = StyleSheet.create({
  ...
  dot: { width: 6, height: 6, borderRadius: 3, backgroundColor: '#1B263B', marginHorizontal: 3 },
  ...
  cardFront: { backgroundColor: '#243B53', borderWidth: 3, borderColor: '#0D1B2A' },
  cardElevated: { shadowColor: '#000', shadowOpacity: 0.4, shadowRadius: 0, shadowOffset: { width: 2, height: 4 }, elevation: 12 },
  cardBack: { transform: [{ rotateY: '180deg' }] },
  cardBackSurface: { backgroundColor: '#243B53', borderWidth: 3, borderColor: '#0D1B2A' },
  ...
  deckCard: { position: 'absolute', top: 0, left: 0, width: CARD_W, height: CARD_H, borderRadius: 22, backgroundColor: '#252829', overflow: 'hidden', borderWidth: 3, borderColor: '#0D1B2A', shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 0, shadowOffset: { width: 2, height: 3 }, elevation: 6 },
  deckCardNext: { opacity: 0.95, backgroundColor: '#1B263B', borderColor: '#0D1B2A' },
  deckCardThird: { opacity: 0.85, transform: [{ translateY: 34 }, { translateX: 8 }, { scale: 0.93 }], backgroundColor: '#1E2122', borderColor: '#0D1B2A' },
  ...
  tabBar: { position: 'absolute', left: 0, right: 0, bottom: 0, height: 54, borderTopWidth: StyleSheet.hairlineWidth, borderTopColor: '#1B263B', flexDirection: 'row', backgroundColor: 'rgba(17,17,17,0.9)' },
