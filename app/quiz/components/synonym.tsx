...
const WORDS: WordEntry[] = [
  {
    word: 'home',
    ipa: '/hoʊm/',
    correct: ['house', 'place', 'where you live'],
    incorrectPool: ['school', 'store', 'park', 'street'],
  },
  {
    word: 'food',
    ipa: '/fuːd/',
    correct: ['meal', 'eating', 'lunch'],
    incorrectPool: ['drink', 'water', 'game', 'book'],
  },
  {
    word: 'brother',
    ipa: '/ˈbrʌðər/',
    correct: ['sibling', 'family', 'boy in family'],
    incorrectPool: ['friend', 'teacher', 'neighbor', 'classmate'],
  },
  {
    word: 'family',
    ipa: '/ˈfæməli/',
    correct: ['relatives', 'parents', 'mom and dad'],
    incorrectPool: ['friends', 'teachers', 'neighbors', 'classmates'],
  },
  {
    word: 'friend',
    ipa: '/frend/',
    correct: ['buddy', 'pal', 'someone you like'],
    incorrectPool: ['enemy', 'stranger', 'teacher', 'boss'],
  },
];
