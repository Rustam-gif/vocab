    ...
    <SafeAreaView style={[styles.container, isLight && { backgroundColor: colors.background }]}>
      ...
      {(!ImagePicker) && (
        <View style={[styles.notice, isLight && styles.noticeLight]}>
          ...
          <Text style={[styles.noticeSub, isLight && { color: '#2D4A66' }]}>Run these in your project:</Text>
          <Text style={[styles.codeLine]}>npm i react-native-image-picker</Text>
          <Text style={[styles.codeLine]}>cd ios && pod install</Text>
          <Text style={[styles.noticeSub, { marginTop: 6 }, isLight && { color: '#2D4A66' }]}>Then rebuild the app.</Text>
        </View>
      )}
      ...
      {showReview && (
        <View style={styles.reviewOverlay}>
          <View style={[styles.reviewCard, isLight && styles.reviewCardLight]}>
            ...
            <Text style={[styles.reviewSub, isLight && { color: '#2D4A66' }]}>
      ...
      {showHint && !picked && (
        <View pointerEvents="auto" style={styles.hintOverlay}>
          <View style={styles.hintCard}>
            ...
            <Text style={[styles.hintLine, isLight && { color: '#2D4A66' }]}>1. Tap “Open Camera”.</Text>
            <Text style={[styles.hintLine, isLight && { color: '#2D4A66' }]}>2. Point at your copybook page.</Text>
            <Text style={[styles.hintLine, isLight && { color: '#2D4A66' }]}>3. Capture, then press “Recognize”.</Text>
            <Text style={[styles.hintLine, isLight && { color: '#2D4A66' }]}>4. Deselect any wrong words and save.</Text>
            <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  notice: { margin: 12, padding: 12, backgroundColor: '#243B53', borderRadius: 10 },
  ...
  folderChip: { backgroundColor: '#2D4A66', paddingHorizontal: 12, paddingVertical: 8, borderRadius: 16, marginRight: 8 },
  ...
  folderChipTextInactive: { color: '#2D4A66', fontWeight: '700' },
  ...
  preview: { width: '100%', height: 280, borderRadius: 12, backgroundColor: '#0D1B2A' },
  secondaryBtn: { backgroundColor: '#2D4A66', paddingVertical: 10, paddingHorizontal: 14, borderRadius: 10 },
  ...
  hintLine: { fontSize: 14, color: '#2D4A66', marginVertical: 2 },
  hintBtn: { marginTop: 12, backgroundColor: '#0D1B2A', borderRadius: 10, paddingVertical: 10, alignItems: 'center' },
  ...
  reviewCard: { width: '92%', maxWidth: 520, borderRadius: 16, backgroundColor: '#1B263B', padding: 16, shadowColor: '#000', shadowOpacity: 0.3, shadowRadius: 12, shadowOffset: { width: 0, height: 8 }, elevation: 12 },
  ...
  actionChip: { backgroundColor: '#243B53', paddingHorizontal: 10, paddingVertical: 8, borderRadius: 12 },
