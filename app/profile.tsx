...
const styles = StyleSheet.create({
  ...
  streakCountBadge: { marginLeft: 6, backgroundColor: '#0D1B2A', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 10 },
  ...
  streakDot: { width: 18, height: 18, borderRadius: 9, backgroundColor: '#2D4A66' },
  ...
  moreInfoCardDark: { backgroundColor: '#1B263B' },
  moreInfoTitle: { fontSize: 18, fontWeight: '800', color: '#FFFFFF' },
  moreInfoTitleLight: { color: '#0D1B2A' },
  ...
  pillOff: { backgroundColor: '#1B263B' },
  ...
  freqChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 14, backgroundColor: '#1B263B', borderWidth: 1, borderColor: 'rgba(78,217,203,0.2)' },
  ...
  freqChipTextLight: { color: '#2D4A66', fontWeight: '700' },
  freqChipTextActive: { color: '#FFFFFF' },
  smallBtn: { paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, backgroundColor: '#1B263B', borderWidth: 1, borderColor: 'rgba(78,217,203,0.2)' },
  smallBtnLight: { backgroundColor: '#FFFFFF', borderColor: '#E5E7EB' },
  smallBtnText: { color: '#E5E7EB', fontWeight: '700' },
  smallBtnTextLight: { color: '#2D4A66', fontWeight: '700' },
  ...
  themeToggleTextLight: { color: '#2D4A66' },
  ...
  langChipDark: { backgroundColor: '#1B263B' },
  ...
  langSearchBox: { marginTop: 6, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#1B263B', borderWidth: 1.5, borderColor: 'rgba(78,217,203,0.15)' },
  ...
  langRowDark: { backgroundColor: '#1B263B', borderWidth: 1.5, borderColor: 'rgba(78,217,203,0.15)' },
  signInContainer: {
    flex: 1,
    justifyContent: 'center',
    alignItems: 'stretch',
  ...
  signInSubtitleLight: { color: '#2D4A66' },
  ...
  appleButton: { backgroundColor: '#1B263B' },
