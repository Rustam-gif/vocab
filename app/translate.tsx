      ...
      >
        ...
        <View style={[styles.card, isLight && styles.cardLight]}>
          ...
          <View style={[styles.row, { marginTop: 8, justifyContent: 'space-between' }]}>
            ...
            <TouchableOpacity style={[styles.translateBtn, isLight && styles.translateBtnLight]} onPress={doTranslate} disabled={loading || !word.trim()}>
...
const styles = StyleSheet.create({
  ...
  title: { color: '#E5E7EB', fontWeight: '800', fontSize: 18, fontFamily: 'Feather-Bold' },
  ...
  cardLight: { backgroundColor: '#FFFFFF', borderColor: '#E5E7EB', borderWidth: 2, shadowOpacity: 0.1, shadowColor: '#9CA3AF' },
  ...
  swapIconLight: { backgroundColor: '#FFFFFF', borderColor: '#E5E7EB', shadowOpacity: 0.1, shadowColor: '#9CA3AF' },
  translateBtn: {
  ...
  translateBtnLight: { borderColor: '#2D9A8F', shadowColor: '#2D9A8F', shadowOpacity: 0.25 },
  ...
  resultCardLight: { backgroundColor: '#FFFFFF', borderColor: '#E5E7EB', borderWidth: 2, shadowOpacity: 0.1, shadowColor: '#9CA3AF' },
  bigWord: { fontSize: 28, fontWeight: '900', color: '#E5E7EB', textAlign: 'center', fontFamily: 'Feather-Bold' },
  ...
  exampleTag: { marginRight: 6, marginTop: 1, color: '#B6E0E2', fontWeight: '800', fontSize: 11, fontFamily: 'Ubuntu-Bold' },
  exampleTagLight: { color: '#0D3B4A' },
  examplesHeader: { marginTop: 2, color: '#E5E7EB', fontSize: 13, fontWeight: '800', fontFamily: 'Ubuntu-Bold' },
  examplesHeaderLight: { color: '#111827' },
  exampleLabel: { color: '#9CA3AF', fontSize: 12, fontWeight: '700', fontFamily: 'Ubuntu-Medium' },
  exampleLabelLight: { color: '#6B7280' },
  exampleBold: { fontWeight: '800', color: '#E5E7EB', fontFamily: 'Ubuntu-Bold' },
  ...
  savedLine: { color: '#4ED9CB', fontWeight: '700', fontFamily: 'Ubuntu-Medium' },
  practiceBtn: {
    marginTop: 12,
    alignSelf: 'center',
  ...
  practiceBtnLight: { shadowOpacity: 0.12 },
  practiceTxt: { color: '#0D3B4A', fontWeight: '800', fontFamily: 'Ubuntu-Bold' },
  historyTitle: { marginTop: 10, fontWeight: '800', color: '#E5E7EB', fontFamily: 'Feather-Bold' },
