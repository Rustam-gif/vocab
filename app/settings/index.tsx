...
const styles = StyleSheet.create({
  ...
  toggle: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 12, backgroundColor: '#1B263B', borderWidth: 1, borderColor: '#2D4A66' },
  ...
  chip: { paddingVertical: 6, paddingHorizontal: 10, borderRadius: 10, backgroundColor: '#1B263B' },
  chipLight: { backgroundColor: '#E9E6E0' },
  chipDark: { backgroundColor: '#1B263B' },
  chipText: { color: '#FFFFFF', fontWeight: '700' },
  actionSmall: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 10, backgroundColor: '#1B263B' },
  ...
  freqChip: { paddingVertical: 8, paddingHorizontal: 12, borderRadius: 12, backgroundColor: '#1B263B', borderWidth: 1, borderColor: '#2D4A66' },
  ...
  langModal: { width: '86%', backgroundColor: '#243B53', borderRadius: 16, padding: 14 },
  langModalLight: { backgroundColor: '#FFFFFF' },
  modalTitle: { color: '#E5E7EB', fontWeight: '800', marginBottom: 6 },
  modalTitleLight: { color: '#111827' },
  searchBox: { marginTop: 6, borderRadius: 10, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: '#1B263B', borderWidth: 1, borderColor: '#1B263B', flexDirection: 'row', alignItems: 'center' },
